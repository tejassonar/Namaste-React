...
import { getCorsProxyUrl } from "../utils/functions/corsProxyUrl";
...
const Body = () => {
  ...
  const fetchRestaurants = async () => {
    try {
      ...
      if (!type.phone()) {
        const restaurantsUrl = getCorsProxyUrl(
          "https://www.swiggy.com/dapi/restaurants/list/v5?lat=19.2403305&lng=73.1305395"
        );
        ...
        const restaurantsUrl = getCorsProxyUrl(
          "https://www.swiggy.com/mapi/homepage/getCards?lat=19.2403305&lng=73.1305395"
        );
        const res = await fetch(restaurantsUrl);
        const data = await res.json();
    ...
    <div className="flex flex-col">
      <div className="flex items-center my-8 justify-center">
        ...
        <button
          ...
          className="transition delay-150 duration-300 ease-in-out px-4 py-2 mx-8  self-start rounded-md text-white font-semibold bg-[#f55733] shadow-md"
        >
